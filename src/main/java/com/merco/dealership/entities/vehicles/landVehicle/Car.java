package com.merco.dealership.entities.vehicles.landVehicle;
...
@Entity
@Table(name = "tb_cars")
public class Car extends LandVehicle implements Serializable {
	...
	public Car(String id, @NotNull(message = "Required field") String brand,
			   ...
			   String steeringType, Integer tireSize, Integer doors, Double trunkCapacity, String driveType) {
